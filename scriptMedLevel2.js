...
// Medium DAY 2 (LEVEL 2)  CUSTOMER 4 (QUESTION 4) START

function medLevel2Q4(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 28 pennies, 29 nickels, 18 dimes, 19 quarters, and 29 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel2Q5()"> Customer 5 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel2Q5()"> Submit</button>`
...
// Medium  DAY 2 (LEVEL 2)  CUSTOMER 4 (QUESTION 4) END

// Medium DAY 2 (LEVEL 2)  CUSTOMER 5 (QUESTION 5) START

function medLevel2Q5(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 21 pennies, 12 nickels, 16 dimes, 24 quarters, and 17 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel2Q6()"> Customer 6 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel2Q6()"> Submit</button>`
...
// Medium  DAY 2 (LEVEL 2)  CUSTOMER 5 (QUESTION 5) END

// Medium  DAY 2 (LEVEL 2)  CUSTOMER 6 (QUESTION 6) START
function medLevel2Q6(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 14 pennies, 16 nickels, 22 dimes, 13 quarters, and 27 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel2Q7()"> Customer 7 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel2Q7()"> Submit</button>`
...
// Medium  DAY 2 (LEVEL 2)  CUSTOMER 6 (QUESTION 6) END

// Medium  DAY 2 (LEVEL 2)  CUSTOMER 7 (QUESTION 7) START
function medLevel2Q7(){
 // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 13 pennies, 23 nickels, 33 dimes, 14 quarters, and 31 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel2Q8()"> Customer 8 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel2Q8()"> Submit</button>`
...
// Medium  DAY 2 (LEVEL 2)  CUSTOMER 7 (QUESTION 7) END
...
function medLevel2Q9(){
 // Names
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 28 pennies, 31 nickels, 23 dimes, 15 quarters, and 13 fifty-cents... . How much money do I have? ` 
...
function medLevel2Q10(){
 // Names
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 32 pennies, 12 nickels, 23 dimes, 10 quarters, and 35 fifty-cents... . How much money do I have? ` 
