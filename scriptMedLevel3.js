...
// Medium DAY 3 (LEVEL 3)  CUSTOMER 4 (QUESTION 4) START

function medLevel3Q4(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 21 pennies, 23 nickels, 14 dimes, 33 quarters, and 35 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel3Q5()"> Customer 5 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel3Q5()"> Submit</button>`
...
// Medium  DAY 3 (LEVEL 3)  CUSTOMER 4 (QUESTION 4) END

// Medium DAY 3 (LEVEL 3)  CUSTOMER 5 (QUESTION 5) START

function medLevel3Q5(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 30 pennies, 32 nickels, 21 dimes, 11 quarters, and 27 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel3Q6()"> Customer 6 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel3Q6()"> Submit</button>`
...
// Medium  DAY 3 (LEVEL 3)  CUSTOMER 5 (QUESTION 5) END

// Medium  DAY 3 (LEVEL 3)  CUSTOMER 6 (QUESTION 6) START
function medLevel3Q6(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 13 pennies, 24 nickels, 28 dimes, 17 quarters, and 20 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel3Q7()"> Customer 7 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel3Q7()"> Submit</button>`
...
// Medium  DAY 3 (LEVEL 3)  CUSTOMER 6 (QUESTION 6) END

// Medium  DAY 3 (LEVEL 3)  CUSTOMER 7 (QUESTION 7) START
function medLevel3Q7(){
 // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 30 pennies, 14 nickels, 19 dimes, 16 quarters, and 12 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel3Q8()"> Customer 8 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel3Q8()"> Submit</button>`
...
// Medium  DAY 3 (LEVEL 3)  CUSTOMER 7 (QUESTION 7) END

// Medium  DAY 2 (LEVEL 2)  CUSTOMER 8 (QUESTION 8) START
function medLevel2Q8(){
 // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 33 pennies, 20 nickels, 23 dimes, 13 quarters, and  27 fifty-cents... . How much money do I have? ` 
...
function medlevel3Q9(){
 // Names
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 12 pennies, 35 nickels, 31 dimes, 29 quarters, and 15 fifty-cents... . How much money do I have? ` 
...
function medlevel3Q10(){
 // Names
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 21 pennies, 26 nickels, 29 dimes, 23 quarters, and 13 fifty-cents... . How much money do I have? ` 
...
// MED  DAY 3 (LEVEL 3)  CUSTOMER 10 (QUESTION 10) END

function level3End(){
  document.getElementById("display").innerHTML=` <b> Boss :</b> Great Job Today!!! <br> <a href="MedLevelkkkk.html"><button> Move on to Medium Day 4 (Level 4) </button> </a>`
}