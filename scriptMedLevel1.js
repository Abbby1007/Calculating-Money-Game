...
// Medium DAY 1 (LEVEL 1)  CUSTOMER 4 (QUESTION 4) START

function medLevel1Q4(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 21 pennies, 17 nickels, 19 dimes, 22 quarters, and 24 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel1Q5()"> Customer 5 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel1Q5()"> Submit</button>`
...
// Medium  DAY 1 (LEVEL 1)  CUSTOMER 4 (QUESTION 4) END

// Medium DAY 1 (LEVEL 1)  CUSTOMER 5 (QUESTION 5) START

function medLevel1Q5(){
  // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 33 pennies, 25 nickels, 34 dimes, 26 quarters, and 35 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel1Q6()"> Customer 6 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel1Q6()"> Submit</button>`
...
function medLevel1Q6(){
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 22 pennies, 17 nickels, 28 dimes, 25 quarters, and 15 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel1Q7()"> Customer 7 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel1Q7()"> Submit</button>`
...
// Medium  DAY 1 (LEVEL 1)  CUSTOMER 6 (QUESTION 6) END

// Medium  DAY 1 (LEVEL 1)  CUSTOMER 7 (QUESTION 7) START
function medLevel1Q7(){
 // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 17 pennies, 16 nickels, 25 dimes, 29 quarters, and 34 fifty-cents... . How much money do I have? ` 
  ...
  if(input == correct){
     document.getElementById("display").innerHTML=` <b> ${randomName}:</b> ${randomcompliment} <br><button onclick="medLevel1Q8()"> Customer 8 </button>`
    document.getElementById("submitButton").innerHTML = `<button onclick="medLevel1Q8()"> Submit</button>`
...
// Medium  DAY 1 (LEVEL 1)  CUSTOMER 7 (QUESTION 7) END

// Medium  DAY 1 (LEVEL 1)  CUSTOMER 8 (QUESTION 8) START
function medLevel1Q8(){
 // Names
  const name = ["Stanley", "Trevor", "Eva", "Poppy","Darren","Jake","Selena","Ariana","Leonard","Troy","Makenzie","Logan","Emma","Abigail","Keana","Isabella","Skyla","Zachary","Jude","Hailey","Emily","Kayla","Jessica","Carol","Alex","Noah","Sadie","Michael","Julia","Sarah","Ashley","Madison","Howard","Sheryl","Adriyel"]
   const randomName = name[Math.floor(Math.random() * name.length)];
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 29 pennies, 31 nickels, 32 dimes, 17 quarters, and  25 fifty-cents... . How much money do I have? ` 
...
// Medium  DAY 1 (LEVEL 1)  CUSTOMER 8 (QUESTION 8) END
...
function level10Q9(){
 // Names
  ...
  document.getElementById("question").innerHTML= `<b> ${randomName} </b> I have 27 pennies, 16 nickels, 25 dimes, 35 quarters, and 33 fifty-cents... . How much money do I have? ` 
